...
\begin{itemize}
  ...
  \item Deux vecteurs colinéaires sont les supports de droites parallèles. Ca "se voit" sur un dessin, et nous le clarifierons dans la prochaine partie, où nous définirons plus précisément ce qu'est une droite. 
\end{itemize}
